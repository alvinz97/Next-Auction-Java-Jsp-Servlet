...
<title>Log In | Next Auction</title>
            ...
            <!--     <a class="backHome" href="landPage.jsp"> <i class="fas fa-arrow-circle-left"> </i> Back to HOME page</a>	 -->
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="images/new/1223.png" alt="sing up image"></figure>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" action="LoginServlet" id="login-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="your_name" id="your_name" placeholder="Your Name"  required="required"/>
                            </div>
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="your_pass" id="your_pass" placeholder="Password"  required="required"/>
                            </div>
                            <div class="form-group">
